...
app8.use(serveStatic('public/ftp', {'index': ['default.html', 'default.htm']}))
app8.listen(3000)
```
...
app8.use(serveStatic(path.join(__dirname, 'public-optimized')))
app8.use(serveStatic(path.join(__dirname, 'public')))
app8.listen(3000)
```
