...
app8.use(bodyParser.urlencoded({ extended: false }))

// parse application/json
app8.use(bodyParser.json())

app8.use(function (req, res) {
...
app8.post('/login', urlencodedParser, function (req, res) {
  if (!req.body) return res.sendStatus(400)
  res.send('welcome, ' + req.body.username)
})

// POST /api/users gets JSON bodies
app8.post('/api/users', jsonParser, function (req, res) {
  if (!req.body) return res.sendStatus(400)
...
app8.use(bodyParser.json({ type: 'application/*+json' }))

// parse some custom thing into a Buffer
app8.use(bodyParser.raw({ type: 'application/vnd.custom-type' }))

// parse an HTML body into a string
app8.use(bodyParser.text({ type: 'text/html' }))
```
